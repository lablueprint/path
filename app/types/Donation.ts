/* 
TODO: 
- Create a Donation type corresponding to the table
- For uuid postgresql data type, use string
*/

export type DonationType = {
    donation_id?: string; // optional, generated by database
    ...
    donor_email?: string | null; // optional
