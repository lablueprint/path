...
export default function TicketDestStoreDropdown({
    ...
    const [selectedDestStore, setSelectedDestStore] = useState<Store | null>(currentDestStore);
    const [originalDestStore, setOriginalDestStore] = useState<Store | null>(currentDestStore);
    ...
    const handleSave = async () => {
        ...
        const result = await updateTicketDestStore(selectedDestStore?.store_id ?? null, ticketId);
        if (result.success) {
