...
export default function AddStoreForm() {
    ...
    const storeStreetAddress = watch("storeStreetAddress");
   
    const bothFilled = storeName.trim().length > 0 && storeStreetAddress.trim().length > 0;
    const eitherFilled = storeName.trim().length > 0 || storeStreetAddress.trim().length > 0;
